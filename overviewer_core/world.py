...
class RegionSet(object):
    ...
    def __init__(self, regiondir, rel):
        ...
        self._blockmap = {
            ...
            'minecraft:warped_sign': (ids.minecraft__warped_sign, 0),
            'minecraft:crimson_sign': (ids.minecraft__crimson_sign, 0),
            ...
            'minecraft:warped_wall_sign': (ids.minecraft__warped_wall_sign, 0),
            'minecraft:crimson_wall_sign': (ids.minecraft__crimson_wall_sign, 0),
    ...
    def _get_block(self, palette_entry):
        ...
        if block in [ids.minecraft__redstone_ore, ids.minecraft__redstone_lamp]:
            ...
            if ((block in ids.group_piston and p.get('extended', 'false') == 'true') or (block == ids.minecraft__piston_head and p.get('type', 'normal') == 'sticky') or (block == ids.minecraft__observer and p.get('powered', 'false') == 'true')):
                data |= 0x08
